        ...
        <form onSubmit={onSubmit} className="form-control">
          <div className="btn-group mx-auto my-5 justify-center">
            ...
            <input
              ...
              className={`btn rounded-none ${
                listing.type === 'for-breakfast' ? 'btn-outline' : 'btn-ghost'
              }`}
              onClick={onMutate}
              required
            />
            ...
            <input
              ...
              className={`btn rounded-none ${
                listing.type === 'parfumeria' ? 'btn-outline' : 'btn-ghost'
              }`}
              onClick={onMutate}
              required
            />
            ...
            <input
              ...
              className={`btn rounded-none ${
                listing.type === 'home-appliances' ? 'btn-outline' : 'btn-ghost'
              }`}
              onClick={onMutate}
              required
            />
